...
**Status:** M2 completo ✅ | Próximo: M3 Checkout + Pagamento PIX
**Sprint Atual:** M2 (CRUD Completo) - FINALIZADO ✅
**Próxima Sprint:** M3 (Checkout e Pagamento)

**Progresso:**
- ✅ **M1** - Setup e Core Mínimo (Auth + OAuth MP)
- ✅ **M2** - CRUD Completo (Eventos, Modalidades, Lotes, Cupons)
- 🚧 **M3** - Checkout + Pagamento PIX (próximo)
- 📅 **M4** - Webhook + Finalização
