...
**Status:** M3 completo ✅ | Backend MVP 95% pronto!
**Sprint Atual:** M3 (Checkout e Pagamento) - FINALIZADO ✅
**Próxima Sprint:** M4 (Webhook) ou Frontend

**Progresso:**
- ✅ **M1** - Setup e Core Mínimo (Auth + OAuth MP)
- ✅ **M2** - CRUD Completo (Eventos, Modalidades, Lotes, Cupons)
- ✅ **M3** - Checkout + Pagamento PIX (pricing, validações, mock PIX)
- 📅 **M4** - Webhook MP (confirmação de pagamento)
