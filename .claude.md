...
### 🚧 Em Andamento
- [ ] **M1.2: Autenticação (JWT)** - Próximo passo

### 📅 Próximos Passos (Super MVP)
1. **M1.2: Autenticação** (2-3 dias)
...
**Sprint Atual:** M4 (Webhook) - FINALIZADO ✅
**Próxima Sprint:** Frontend (Páginas e Componentes React)

**Progresso Backend:**
- ✅ **M1** - Setup e Core Mínimo (Auth JWT + OAuth MP)
- ✅ **M2** - CRUD Completo (Eventos, Modalidades, Lotes, Cupons)
- ✅ **M3** - Checkout + Pagamento PIX (pricing, validações)
- ✅ **M4** - Webhook MP (confirmação automática de pagamento)

**Total implementado:**
- ✅ 26 endpoints REST funcionando
- ✅ Autenticação e autorização completas
- ✅ Sistema de pricing com cupons e lotes
- ✅ Integração Mercado Pago (OAuth + Webhook)
- ✅ Validações Zod em todas as rotas
