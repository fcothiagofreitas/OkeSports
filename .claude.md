...
**Status:** M1.3 completo ✅ | Próximo: M2 CRUD de Eventos
**Sprint Atual:** M1 (Setup e Core Mínimo) - FINALIZADO ✅
**Próxima Sprint:** M2 (CRUD de Eventos)

**Progresso M1:**
1. ✅ M1.1 - Setup inicial (Next.js, Tailwind, Prisma)
2. ✅ M1.2 - Autenticação (JWT, Register, Login, Refresh Token)
3. ✅ M1.3 - OAuth Mercado Pago (Authorize, Callback, Status, Disconnect)
4. ⏭️ M1.4 - Dashboard (será feito junto com M2)
